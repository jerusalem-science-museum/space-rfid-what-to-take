...
# Add tmux autostart to .bashrc (only on login shells, only once)
...
echo "   2. To access the running app: tmux attach -t kiosk"
echo "   3. To detach without stopping: Ctrl+B then D"
echo "============================================="
